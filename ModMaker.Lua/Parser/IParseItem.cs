...
namespace ModMaker.Lua.Parser {
  ...
  /// statement or a binary expression.
  /// </summary>
  ...
  /// <summary>
  /// A parse item that is an expression, such as a binary expression or a function call.
  /// </summary>
  public interface IParseExp : IParseItem { }
  /// <summary>
  /// A parse item that is a prefix expression, these are also expressions, but can be used as
  /// prefixes for indexers and function calls.
  /// </summary>
