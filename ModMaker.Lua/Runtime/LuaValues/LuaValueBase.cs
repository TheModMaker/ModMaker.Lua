...
{
    /// <summary>
    /// Defines a base class for the standard LuaValue's.  This
    /// uses the visitor pattern to pick the correct function
    /// to call.  This is the base type for all LuaValue's, for
    /// user-defined types, see LuaUserData&lt;T&gt;.
    /// </summary>
    public abstract class LuaValueBase : ILuaValue, ILuaValueVisitor
    {
        ...
        public static ILuaValue CreateValue(object value)
        {
            ...
            ILuaValue luaValue = value as ILuaValue;
            if (luaValue != null)
                return luaValue;
            ...
            if (delegate_ != null)
            {
                return new LuaOverloadFunction(delegate_.Method.Name,
                                               new[] { delegate_.Method },
        ...
        public virtual bool TypesCompatible<T>()
        {
            ...
            MethodInfo m;
            int i;
            return Helpers.TypesCompatible(value.GetType(), typeof(T), out m, out i) != LuaCastType.NoCast;
        }
        /// <summary>
        ...
        public virtual void GetCastInfo<T>(out LuaCastType type, out int distance)
        {
           if (typeof(T).IsAssignableFrom(GetType()))
           {
            ...
            // Sometimes this will return |this|; assume this is intended
            // behavior.
            var value = GetValue();
            if (value == null)
            {
            ...
            MethodInfo m;
            type = Helpers.TypesCompatible(value.GetType(), typeof(T), out m, out distance);
        }
        /// <summary>
        ...
        public virtual T As<T>()
        {
            ...
            MethodInfo m;
            int distance;
            if (Helpers.TypesCompatible(value.GetType(), typeof(T), out m, out distance) != LuaCastType.NoCast)
            {
                ...
                throw new InvalidCastException(string.Format(Resources.BadCast, value.GetType(), typeof(T)));
        ...
        {
            throw new InvalidOperationException(Errors.CannotCall(this.ValueType));
        }
        ...
        /// </exception>
        /// <remarks>
        /// This would be implemented as always throwing, but then it would
        /// not support user-data as the second argument.
        /// </remarks>
        ...
        /// If the argument is an invalid value.
        /// </exception>
        public virtual ILuaValue Arithmetic(BinaryOperationType type, LuaValues.LuaThread self)
        {
            var ret = AttempMetamethod(type, self, this);
            if (ret != null)
                return ret;
    ...
    public abstract class LuaValueBase<T> : LuaValueBase, ILuaValue<T>
    {
        ...
        {
            LuaValueBase<T> temp = other as LuaValueBase<T>;
            if (temp != null && other.GetType() == this.GetType())
            {
                var comp = Comparer<T>.Default;
                return comp.Compare(this.Value, temp.Value);
            }
