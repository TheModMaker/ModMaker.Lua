...
namespace ModMaker.Lua.Runtime.LuaValues {
  ...
  public abstract class LuaFunction : DynamicObject, ILuaValue, ILuaValueVisitor, IDisposable {
    ...
    /// <param name="args">
    /// The arguments that are passed to the object during the invoke operation. For example, for
    /// the sampleObject(100) operation, where sampleObject is derived from the
    /// System.Dynamic.DynamicObject class, args[0] is equal to 100.
    /// </param>
    ...
    /// is an instance of the class derived from the System.Dynamic.DynamicObject class, binder.Type
    /// returns the System.String type. The binder.Explicit property provides information about the
    /// kind of conversion that occurs. It returns true for explicit conversion and false for
    /// implicit conversion.</param>
