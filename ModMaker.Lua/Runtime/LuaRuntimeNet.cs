...
namespace ModMaker.Lua.Runtime {
  ...
  public class LuaRuntimeNet : ILuaRuntime {
    ...
    /// </summary>
    protected LuaRuntimeNet(ILuaEnvironment env) {
      _env = env;
    ...
    /// </summary>
    private static readonly Type _runtimeType = null;
    ...
    static void _createType() {
      ...
      gen.Emit(OpCodes.Call, typeof(LuaRuntimeNet).GetConstructor(
          ...
          new[] { typeof(ILuaEnvironment) }, null));
      gen.Emit(OpCodes.Ret);

      //// override MultipleReturn Invoke(ILuaEnvironment E, object self, object value,
      ////                                int overload, bool memberCall, object[] args,
      ////                                int[] byRef);
      var mb = tb.DefineMethod("Invoke",
          MethodAttributes.Public | MethodAttributes.Virtual | MethodAttributes.HideBySig,
          typeof(MultipleReturn),
          new[] { typeof(ILuaEnvironment), typeof(object), typeof(object),
                  typeof(int), typeof(bool), typeof(object[]), typeof(int[]) });
      ...
      gen.Emit(
          OpCodes.Callvirt,
          typeof(LuaRuntimeNet).GetMethod("GetValueType",
      ...
      gen.Emit(
          ...
          typeof(string).GetMethod(
              "Concat", new[] { typeof(object), typeof(object), typeof(object) }));
      gen.Emit(OpCodes.Newobj,
    ...
    /// <summary>
    /// Gets the Lua thread object for the current thread.  This will be null for the main thread.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new ILuaValue object that will call the given method. The calling convention of
    /// this method and the type of the object are implementation-defined; however none of the
    /// arguments are null.
    /// </summary>
