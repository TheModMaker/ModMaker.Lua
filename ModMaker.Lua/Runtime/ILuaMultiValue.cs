...
namespace ModMaker.Lua.Runtime {
  /// <summary>
  /// Defines an ordered collection of LuaValues.  This is used as an argument to methods and as the
  /// result.  This is also a LuaValue and under normal operations, should act as the first item.
  /// </summary>
  public interface ILuaMultiValue : ILuaValue, IEnumerable<ILuaValue> {
    ...
    /// should return LuaNil. This should never return null.  Setting the value outside the current
    /// range has no effect.
    /// </summary>
