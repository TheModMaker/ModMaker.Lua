...
namespace ModMaker.Lua.Runtime
{
    ...
    public sealed class LuaClass : IIndexable, IMethod
    {
        ...
        /// is stored in a envField of a type.  Creates one local variable.
        /// Injects:
        /// 
        /// <code>
        ...
        /// <param name="methodField">The envField (of type LuaMethod) that contains the method to call.</param>
        /// <param name="_E">The envField that stores the environment.</param>
        ...
        {
            // MultipleReturn ret = E.Runtime.Invoke(E, this.{envField}, -1, arguments);
