  ...
  public class Bit32 : LibraryTestBase {
    ...
    public void arshift() {
      _lua.DoText(@"
        ...
        assertEquals(0xffffff00, bit32.arshift(0x80000000, 23),
                     'arshift: high-bit fill small value')
        ...
        assertEquals(0xf0,       bit32.arshift(0xff0000000f, -4),
                     'arshift(left): larger than 32-bit')
    ...
    public void bor() {
      _lua.DoText(@"
        ...
        assertEquals(0xff,       bit32.bor(0xff000000f0, 0xff0000000f), 'bor: >32-bits')
      ");
    }
    ...
    public void btest() {
      _lua.DoText(@"
        ...
        assertEquals(false, bit32.btest(0xff000000f0, 0xff0000000f), 'btest: >32-bits')
      ");
    }
    ...
    public void bxor() {
      _lua.DoText(@"
        ...
        assertEquals(0xff,       bit32.bxor(0xff000000f0, 0xff0000000f), 'bxor: >32-bits')
      ");
    }
    ...
    public void replace() {
      _lua.DoText(@"
        ...
        assertEquals(0x918aa,    bit32.replace(0x918ea, 0x2462a, 2, 10, 'cat'),
                     'replace: extra args')
