...
namespace UnitTests.Parser {
  ...
  class BufferedStringReaderTest {
    Stream _createStream(string str) {
    ...
    /// <summary>
    /// A read-only stream that splits a combining character across different reads.
    /// </summary>
    ...
    public void DetectsEncodings() {
      ...
      var reader = new BufferedStringReader(new MemoryStream(utf8), null);
      Assert.AreEqual("😀", reader.Read(10));
